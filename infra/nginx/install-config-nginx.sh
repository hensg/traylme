...
sudo chown -R ubuntu /var/www/trayl.me/
sudo mkdir -p /var/nginx/cache
sudo chown -R ubuntu /var/nginx/cache
sudo mkdir -p /var/logs/nginx
sudo chown -R ubuntu /var/logs/nginx
...
sudo chown -R ubuntu /etc/letsencrypt/live/trayl.me
